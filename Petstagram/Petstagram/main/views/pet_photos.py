...
def show_pet_photo_details(request, pk):# prefetch_related  е да работи базата по бързо с по малко заявки
...
def like_pet_photo(request, pk):
    ...
    return redirect('pet photo details', pk)# лайква и редиректва пак към същата страница
